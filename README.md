...
I build maintainable test automation for web and API systems: Playwright + TypeScript for UI, Java + REST Assured for APIs, JMeter/LoadRunner for performance — all wired into CI.  
**3.6 years** in QA automation · Bhopal, India · Open to SDET roles (hybrid/remote).
...
**UI:** Playwright, Selenium · **API:** REST Assured, Playwright request · **Perf:** JMeter, LoadRunner  
**Languages:** TypeScript, Java, JavaScript, SQL · **CI/CD:** GitHub Actions, Azure DevOps, Jenkins

## Contact

[LinkedIn](https://www.linkedin.com/in/link-tbd) · satyamchouksey88@gmail.com
